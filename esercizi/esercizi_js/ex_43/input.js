//VERIFICA ISTANZA
//Crea 1 istanza per la classe Automobile e 1 per la classe Camion. Utilizza l'operazione instanceof per verificare se le istanze create appartengono alle rispettive classi. Aggiungi un metodo statico verificaIstanza(obj, classe) nella classe Automobile che utilizza instanceof per verificare se obj è un'istanza di classe e restituisce un messaggio appropriato.
